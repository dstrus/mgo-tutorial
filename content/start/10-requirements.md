...
* Move Skyrim VR out of the <span class="file"><i class="fa fa-folder-open"></i> C:\Program Files</span> folder to avoid issues with Windows Defender and other antivirus products ([instructions <i class="fa-solid fa-arrow-up-right-from-square"></i>](https://help.steampowered.com/en/faqs/view/4BD4-4528-6B2E-8327#default))
