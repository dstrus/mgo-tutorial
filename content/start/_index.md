...
Before jumping into the action, there are a few things that you _must_ do, and a few more that you probably _ought_ to do.
...
Time to download and install the actual list with Wabbajack.

## [Pre-Game (MO2)](pre-game)
