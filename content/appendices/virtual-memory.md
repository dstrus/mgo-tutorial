...
7. With your NVMe drive highlighted, click {{< btn-inline >}}<i class="fa-regular fa-circle-dot"></i> Custom size{{</ btn-inline >}} and enter `40000` as both the _Initial size_ and the _Maximum size_. (You will need to keep 40 GB free on this drive to take advantage of this.)
