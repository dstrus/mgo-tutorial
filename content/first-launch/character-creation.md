...
In many RPGs, your build is a Very Big Deal, and choosing poorly before you've really even started playing can make or break your experience. Skyrim, unlike earlier entries in The Elder Scrolls series, is not that kind of game. In fact, in vanilla, it makes almost no difference. There are no classes, there's no concept of major and minor skills, you don't have birthsign, and racial differences are so minor as to make almost no difference. There are still ways to optimize for certain play styles in vanilla, mostly via the Standing Stones, but those can be changed mid-game. You don't have to commit before you've even picked up a weapon.

With the mods in MGO, it's still hard to really set yourself up for failure by building your character poorly, but the races at least feel like they matter beyond a few tiny bits of dialogue. {{< nexus 26686 >}}Aetherius{{< /nexus >}} overhauls the various races' passive abilities and their starting levels in various skills. This reintroduces the concept of major and minor skills... kind of. In previous games, major and minor skills had a huge impact of how you leveled up your character. That feature remains absent from Skyrim, so you still don't need to be terrified of being a Bosmer when you should have been a Redguard. (In fact, in MGO, your overall level isn't based on leveling up skills at all. It's based on gaining experience through discovering locations and completing quests.) It also starts certain races out with additional spells. Check out the mod page for {{< nexus 26686 >}}Aetherius{{< /nexus >}} to see the details.
